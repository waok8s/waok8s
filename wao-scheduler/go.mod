...
require (
	github.com/waok8s/waok8s/wao-core v1.31.0-beta.0
	github.com/waok8s/waok8s/wao-metrics-adapter v1.31.0-beta.0
)
...
require (
	...
	sigs.k8s.io/custom-metrics-apiserver v1.31.0 // indirect
...
// https://github.com/kubernetes-sigs/scheduler-plugins/blob/v0.31.8/go.mod
replace (
